...
def purchase(token:, amount:, rate:, date:)
  t = Transaction.new(date:)
  t.build_tx_in(token:, amount:, rate:)
  t.save(validate: false)
end

def trade(t_in:, amount_in:, t_out:, amount_out:, date:)
  t = Transaction.new(date:)
...
purchase(token: avax, amount: 0.715, rate: 90.657, date: '2022-01-16')
trade(t_in: jewel, amount_in: 1.72488, t_out: avax, amount_out: 0.35, date: '2022-01-16')
purchase(token: near, amount: 1.42709, rate: 20.08, date: '2022-01-16')
purchase(token: ada, amount: 242.244067, rate: 1.04, date: '2022-01-23')
purchase(token: ftm, amount: 83, rate: 1.93, date: '2022-02-02')
purchase(token: ada, amount: 500, rate: 1.17, date: '2022-02-08')
purchase(token: ftm, amount: 62.11, rate: 1.739, date: '2022-02-21')
purchase(token: ftm, amount: 377.2024, rate: 1.68, date: '2022-02-26')
trade(t_in: mim, amount_in: 275, t_out: ftm, amount_out: 163.6905, date: '2022-02-26')
trade(t_in: dai, amount_in: 175, t_out: ftm, amount_out: 104.1667, date: '2022-02-26')
trade(t_in: usdc, amount_in: 100, t_out: ftm, amount_out: 59.524, date: '2022-02-26')
trade(t_in: usdt, amount_in: 100, t_out: ftm, amount_out: 59.524, date: '2022-02-26')
trade(t_in: ftm, amount_in: 157, t_out: usdc, amount_out: 220, date: '2022-02-18')
trade(t_in: our, amount_in: 295_329.63, t_out: dai, amount_out: 50, date: '2022-02-19')
trade(t_in: ftm, amount_in: 8, t_out: dai, amount_out: 10, date: '2022-02-20')
trade(t_in: medal, amount_in: 155.60, t_out: dai, amount_out: 10, date: '2022-02-20')
trade(t_in: ftm, amount_in: 9, t_out: medal, amount_out: 155.60, date: '2022-02-23')
trade(t_in: exc, amount_in: 6, t_out: ftm, amount_out: 10, date: '2022-03-03')
trade(t_in: boo, amount_in: 6, t_out: ftm, amount_out: 63.26, date: '2022-03-07')
trade(t_in: xBOO, amount_in: 3.4, t_out: boo, amount_out: 6, date: '2022-03-07')
# I managed to go neutral on geist but trying to align with current stuff I guess
sale(token: geist, amount: 197.778, rate: 0, date: '2022-03-07')
purchase(token: our, amount: 105_000, rate: 0, date: '2022-03-07')
trade(t_out: our, amount_out: 400_329.63, t_in: ftm, amount_in: 8, date: '2022-03-07')
purchase(token: ftm, amount: 6, rate: 0, date: '2022-03-10')
sale(token: usdc, amount: 44, rate: 0, date: '2022-03-15')
trade(t_out: exc, amount_out: 6, t_in: ftm, amount_in: 17.7, date: '2022-03-15')
trade(t_in: usdc, amount_in: 275, t_out: mim, amount_out: 275, date: '2022-03-16')
trade(t_in: usdc, amount_in: 143.8, t_out: dai, amount_out: 143.8, date: '2022-03-16')
trade(t_in: usdc, amount_in: 100, t_out: usdt, amount_out: 100, date: '2022-03-16')
purchase(token: tomb, amount: 18.8, rate: 0, date: '2022-03-18')
trade(t_in: mai, amount_in: 42.0706, t_out: tomb, amount_out: 18.8, date: '2022-03-18')
trade(t_in: dai, amount_in: 28.92, t_out: ftm, amount_out: 20.02, date: '2022-03-21')
purchase(token: avax, amount: 1.3958, rate: 74.99, date: '2022-04-12')
sale(token: avax, amount: 0.31, rate: 0, date: '2022-04-12')
trade(t_in: ftm, amount_in: 485.18828, t_out: usdc, amount_out: 579.8, date: '2022-04-13')
purchase(token: ftm, amount: 235.147, rate: 1.063, date: '2022-04-23')
